...
class UserSanggarAdapter(val editListener: (UserData)-> Unit, val deleteListener: (UserData)-> Unit): RecyclerView.Adapter<UserSanggarAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.apply {
            tv_nama_user_recycler?.text = item.sanggar?.nama
